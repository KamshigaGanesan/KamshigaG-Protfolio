...
function Hero() {
return ( <section id="home" className="hero section"> <div className="container hero-content">
    ...
    <div className="hero-copy" data-aos="fade-right">
      ...
      <p className="hero-description">
        ...
        and continuously improving software engineering skills through
        real-world projects.
      </p>
